...
**default_values** | [**Array&lt;RoleSelectDefaultValueResponse&gt;**](RoleSelectDefaultValueResponse.md) |  | [optional] [default to undefined]

## Example

```typescript
import { RoleSelectComponentResponse } from 'dc_rest';
